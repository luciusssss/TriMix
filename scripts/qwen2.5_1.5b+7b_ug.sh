...
expert_model_name_or_path="pkupie/Qwen2.5-1.5B-ug-cpt"
antiexpert_model_name_or_path="Qwen/Qwen2.5-1.5B"
model_name="qwen2.5_trimix_1.5b+7b_ug"
prompt_lang="en"
eval_lang="ug"
...
python infer.py\
    ...
    --output_file inference_results/${model_name}/translation_dialogue/${eval_lang}/${prompt_lang}-prompt_seed${seed}_ug2en_test.json \
    --max_new_tokens 200 \
    --num_exemplar 5 \
    --src_lang ${eval_lang} \
...
python infer.py \
    ...
    --exemplar_file data/translation_dialogue/${eval_lang}/train_${seed}.json \
    --input_file data/translation_dialogue/${eval_lang}/test.json \
    --output_file inference_results/${model_name}/translation_dialogue/${eval_lang}/${prompt_lang}-prompt_seed${seed}_en2ug_test.json \
    --max_new_tokens 200 \
    --num_exemplar 5 \
